...
import teleguManeesha from "@/assets/seruds/telegu-maneesha.jpg";
...
const HERO_BENEFICIARY_IMGS = [
  ...
  { src: ajayGoud, alt: "Ajay Goud" },
  { src: kummariLakshmamma, alt: "Kummari Lakshmamma" },
];
        ...
        <aside className="lg:col-span-2">
          <div id="donate-form" className="lg:sticky lg:top-24">
            <div className="rounded-[20px] bg-[#F8FAFC] p-5 shadow-[0_20px_50px_-15px_rgba(15,76,129,0.25)] ring-1 ring-slate-200">
              ...
              <div className="mt-4">
                <a href="https://donorbox.org/donation-seruds-inc" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center rounded-full bg-[#F97316] px-6 py-3 text-sm font-semibold text-white hover:bg-[#ea6a0c] transition">Donate</a>
              </div>
